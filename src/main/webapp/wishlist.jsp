                            ...
                            <c:forEach items="${requestScope.wishlist}" var="item">
                                <tr class="cart_item">
                                    <td class="product-remove">
                                        <a href="${pageContext.request.contextPath}/removeWishList?itemid=${item.id}"
                                           class="remove">×</a>
                                    </td>
                                    <td class="product-thumbnail">
                                        <a href="${pageContext.request.contextPath}/item?itemid=${item.id}">
                                            <img src="http://localhost/img/goodsimg/${item.image}">
                                        </a>
                                    </td>
                                    <td class="product-info">
                                        <a href="${pageContext.request.contextPath}/item?itemid=${item.id}">${item.name}</a>
                                    </td>
                                    <td class="product-subtotal">
                                        <span class="amount">${item.value}</span>
                                    </td>
                                    <td class="proceed-to-cart">
                                        <a href="${pageContext.request.contextPath}/addToCart?itemid=${item.id}">添加到购物车</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
