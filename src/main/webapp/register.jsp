                ...
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3">
                        <div class="box p-40 p-xs-20 bg-white">
                            <form id="reg_form" method="post" action="${pageContext.request.contextPath}/register">
                                ...
                                <div class="form-group">
                                    <label class="control-labe" for="useremail">E-mail</label>
                                    <input type="text" value="" placeholder="E-mail" name="useremail"
                                           id="useremail"
                                           class="form-control form-item">
                                    <span class="error_tip"></span>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" value="" placeholder="密码" name="userpassword"
                                           id="userpassword"
                                           class="form-control form-item">
                                    <span class="error_tip"></span>
                                </div>
                                <div class="form-group">
                                    <label class="control-label" for="cuserpassword">确认密码</label>
                                    <input type="password" value="" placeholder="确认密码"
                                           name="cuserpassword" id="cuserpassword" class="form-control form-item">
                                    <span class="error_tip"></span>
                                </div>
                                <div class="m-t-15">
                                    <input type="checkbox" name="allow" id="allow" class="m-r-10" value="1"
                                           checked="checked">同意”用户使用协议“
